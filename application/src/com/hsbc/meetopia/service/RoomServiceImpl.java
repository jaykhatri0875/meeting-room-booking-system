...
public class RoomServiceImpl implements RoomService{
	...
	public int createRoom(String meetingName, int capacity, int ratings, int cost, int projector, int wifi, int tv, int conCall, int whiteboard, int waterDispenser, int coffeeMachine) {
		...
		Room meetingRoom = new Room(meetingId,capacity, ratings, cost, new Amenities(meetingId, projector, wifi, conCall, whiteboard, waterDispenser, tv, coffeeMachine)); 
	...
	@Override
	public int updateRoom(String meetingId, int capacity, int ratings, int cost, int projector, int wifi, int tv, int conCall, int whiteboard, int waterDispenser, int coffeeMachine) {
