...
<body>
	<%
		...
		MeetingRoom meetingRoom = meetingRoomService.fetchRoomById(roomid);
    ...
    <div class="card" style="width: 500px; margin-left: 400px;" >
        ...
        <div class="card-body card border-danger mb-3">
	        ...
	        <form action="EditMeetingRoomServlet" method="post">
	             <div class="form-group ">
	                <label class="font-weight-bold" style="font-family: Georgia, 'Times New Roman', Times, serif;">MeetingRoom Id</label>
	                <input type="text" class="form-control card border-danger mb-3" placeholder =" <%=meetingRoom.getuId()%> "disabled>
	            </div> 
	            
	            <div class="form-group ">
	                <label for="meetingId" class="font-weight-bold" style="font-family: Georgia, 'Times New Roman', Times, serif;">MeetingRoom Id</label>
	                <input type="hidden" class="form-control card border-danger mb-3" id="meetingId" name="meetingId" value =" <%=meetingRoom.getuId()%> ">
	            ...
	            <div class="form-group" >
	                ...
	                <input type="text" class="form-control card border-danger mb-3" style="width: 200px;" id="capacity" name="capacity" value='<%=meetingRoom.getSeatingCapacity() %>' required>
	                <div class="valid-feedback">Valid.</div>
	             ...
	             <div class="form-group" >
	                ...
	                <input type="numeric" class="form-control card border-danger mb-3" style="width: 200px;" id="ratings" name="ratings" value='<%=meetingRoom.getRatings() %>' required>
	                <div class="valid-feedback">Valid.</div>
	                <div class="invalid-feedback">Field cannot be empty</div>
	            </div>
	            ...
	            <div class="form-group" >
	                ...
	                <input type="text" class="form-control card border-danger mb-3" style="width: 200px;" id="cost" name="cost" value='<%=meetingRoom.getCostPerHour() %>' required>
	                <div class="valid-feedback">Valid.</div>
	                <div class="invalid-feedback">Field cannot be empty</div>
	            </div>
