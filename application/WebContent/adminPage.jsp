...
<body>
	...
	<div id="mySidebar" class="sidebar">
		...
		<a href="createRoom.jsp">CREATE ROOM</a> <a href="index.jsp">LOGOUT</a>
	</div>
			...
			<div class="card bg-light; card border-danger mb-3">
				<div class="card-body text-center">
					<h5 style="font-family: Georgia, 'Times New Roman', Times, serif;"
						...
						on the meeting name to edit.</label> </br>
					<div class="list-group; card border-danger mb-3"
						style="font-family: Georgia, 'Times New Roman', Times, serif;">
						<a href="editRoom.jsp"
							class="list-group-item list-group-item-action">First item</a> <a
							href="editRoom.jsp"
							class="list-group-item list-group-item-action">Second item</a> <a
							href="editRoom.jsp"
